function [SPP_errors, SPP_falsePositiveErrors, SPP_falseNegativeErrors] = Scenario2_IDO(lidar_range, width, height, resolution, max_vel, images)
    ...
    %% Save the video
    VW = VideoWriter(strcat('../videos/Scenario2_IDO_',string(max_vel),'.avi'));
    VW.FrameRate = 10;
    VW.open();
    for Frame = Frames
        VW.writeVideo(Frame)
