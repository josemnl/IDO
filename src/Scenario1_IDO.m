function [SPP_errors, SPP_falsePositiveErrors, SPP_falseNegativeErrors] = Scenario1_IDO(lidar_range, width, height, resolution, max_vel, decay_factor, images)
    ...
    %% Save the video
    VW = VideoWriter(strcat('../videos/Experiment1_IDO_',string(100*decay_factor),'.avi'));
    VW.FrameRate = 10;
    VW.open();
    for Frame = Frames
        VW.writeVideo(Frame)
